...
public class BasicSlashEnemy : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            aiMovement.GetTargetSearchAlgorithm.moveSpeed = 0f;
            _animator.SetBool(movingBooleanHash, false);
        }
        else
        {
            aiMovement.GetTargetSearchAlgorithm.moveSpeed = aiMovement.GetTargetSearchAlgorithm.baseMoveSpeed;
    ...
    {
        Vector2 direction = aiMovement.GetTargetSearchAlgorithm.LastMoveDirection;
